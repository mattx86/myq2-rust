...
============================
mattx86: cel_shading
NiceAss: Taken from Quake2Max
Discoloda's cel shading outline routine
=============================
*/
...
//					qglColor4f (l* shadelight[0], l*shadelight[1], l*shadelight[2], alpha);
	...
	if (r_celshading->value)
		GL_DrawOutLine(paliashdr, currententity->frame, CEL_WIDTH);
...
void GL_DrawAliasShadow (dmdl_t *paliashdr, int posenum)
{
	...
	height = -lheight + 0.01f; // lowered shadows to ground more - MrG
...
#ifndef CENTERED_GUN // RIOT - Centered gun
	if ( e->flags & RF_WEAPONMODEL )
	{
...
// =================
	...
	if (gl_shadows->value && !(currententity->flags & (RF_TRANSLUCENT | RF_WEAPONMODEL)))
	{
		...
		qglColor4f (0,0,0,(0.4 - ((light[0]+light[1]+light[2])/15)));
