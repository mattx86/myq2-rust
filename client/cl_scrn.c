...
void SCR_DrawDebugGraph (void)
{
	...
	Draw_Fill (x, y-scr_graphheight->value,
		w, scr_graphheight->value, 5, 0.15);
...
void SCR_Init (void)
{
	...
	scr_conspeed = Cvar_Get ("scr_conspeed", "3", CVAR_ZERO);
	scr_showturtle = Cvar_Get ("scr_showturtle", "0", CVAR_ZERO);
	scr_showpause = Cvar_Get ("scr_showpause", "1", CVAR_ZERO);
	scr_centertime = Cvar_Get ("scr_centertime", "2.5", CVAR_ZERO);
	scr_printspeed = Cvar_Get ("scr_printspeed", "8", CVAR_ZERO);
	scr_netgraph = Cvar_Get ("netgraph", "0", CVAR_ZERO);
	scr_timegraph = Cvar_Get ("timegraph", "0", CVAR_ZERO);
	scr_debuggraph = Cvar_Get ("debuggraph", "0", CVAR_ZERO);
	scr_graphheight = Cvar_Get ("graphheight", "32", CVAR_ZERO);
	scr_graphscale = Cvar_Get ("graphscale", "1", CVAR_ZERO);
	scr_graphshift = Cvar_Get ("graphshift", "0", CVAR_ZERO);
	scr_drawall = Cvar_Get ("scr_drawall", "0", CVAR_ZERO);
