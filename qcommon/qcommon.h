...
#define	ERR_FATAL	4		// exit the entire game with a popup window
#define	ERR_DROP	8		// print to console and disconnect from game
#define	ERR_QUIT	16		// not an error, just a normal exit
