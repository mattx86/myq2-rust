...
void Netchan_Init (void)
{
	...
	showpackets = Cvar_Get ("showpackets", "0", CVAR_ZERO);
	showdrop = Cvar_Get ("showdrop", "0", CVAR_ZERO);
...
// check for message overflow
	if (chan->message.overflowed && !chan->message.allowoverflow) // mattx86
	{
		// mattx86: error out maybe?
		Com_Error(ERR_DROP, "%s: Outgoing message overflow\n",
