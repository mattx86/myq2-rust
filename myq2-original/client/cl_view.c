...
void CL_PrepRefresh (void)
{
	...
	CL_LoadClientinfo (&cl.baseclientinfo, "Player\\male/grunt");
...
void V_Init (void)
{
	...
	cl_testblend = Cvar_Get ("cl_testblend", "0", CVAR_ZERO);
	cl_testparticles = Cvar_Get ("cl_testparticles", "0", CVAR_ZERO);
	cl_testentities = Cvar_Get ("cl_testentities", "0", CVAR_ZERO);
	cl_testlights = Cvar_Get ("cl_testlights", "0", CVAR_ZERO);

	cl_stats = Cvar_Get ("cl_stats", "0", CVAR_ZERO);
}
